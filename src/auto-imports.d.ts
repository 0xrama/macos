...
export {}
declare global {
  const AboutThisMac: typeof import('./components/menus/AboutThisMac')['default']
  ...
  const AppleNotes: typeof import('./components/apps/AppleNotes')['default']
  ...
  const LiquidGlass: typeof import('./components/glass/LiquidGlass')['default']
  ...
  const NotificationContainer: typeof import('./components/Notification')['NotificationContainer']
  const Phone: typeof import('./components/apps/Phone')['default']
  const Reminders: typeof import('./components/apps/Reminders')['default']
  ...
  const useGlassSupport: typeof import('./hooks/useGlassSupport')['useGlassSupport']
