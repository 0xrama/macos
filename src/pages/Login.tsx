  ...
  return (
    ...
    >
      <div className="inline-block w-auto relative top-1/2 -mt-40">
        ...
        {/* Password Input */}
        <div
          className="mx-auto grid grid-cols-5 w-44 h-8 mt-4 rounded-lg backdrop-blur-[16px] backdrop-saturate-[180%] bg-white/20"
      ...
      <div className="text-sm fixed bottom-16 inset-x-0 mx-auto flex flex-row space-x-4 w-max">
        ...
        >
          <div
            className="flex-center size-10 bg-gray-800/60 backdrop-blur-[8px] rounded-full"
